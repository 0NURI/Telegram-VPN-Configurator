...
namespace VpnBot
{
    public static class BotConfig
    {
        ...
        internal static long SUPERADMIN_ID = 0;
        ...
        public static async Task Initialise()
        {
            ...
            usersPath = conf[4];
            adminsPath = conf[5];
            if(conf[1] != "SUPERADMIN_CHATID_HERE"){
                ...
                if(!Admins.ContainsKey(SUPERADMIN_ID)) await UploadFileFromLines(adminsPath, [$"{SUPERADMIN_ID},Admin"]);
            }
            yamlPath = conf[2];
